...
const trustedLogos = ["Prestige\nAuto", "SkyLine\nAviation", "Metro\nFleet", "Apex\nAuctions", "Prime\nMotors"];

export default function AutoSync360() {
  ...
  return (
    <div style={{ fontFamily: "'Montserrat', sans-serif", color: C.dark, background: C.bg, minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 68, padding: "0 24px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, cursor: "pointer" }} onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
            <div style={{
              width: 38, height: 38, borderRadius: 8, background: C.accent,
              display: "flex", alignItems: "center", justifyContent: "center",
              fontWeight: 800, fontSize: 17, color: "white",
            }}>A</div>
            <span style={{ fontWeight: 700, fontSize: 16, color: C.black }}>
              AutoSync <span style={{ color: C.accent }}>360</span>
            </span>
          </div>
      ...
      {/* HERO */}
      <section style={{ minHeight: "100vh", display: "flex", alignItems: "center", padding: "100px 24px 60px", background: C.bg }}>
        <div className="as-hero-grid" style={{
          ...
          <Fade delay={0.15} style={{ flex: "1 1 380px", display: "flex", justifyContent: "center" }}>
            <div className="as-hero-img-wrap" style={{
              ...
              <img src="https://images.unsplash.com/photo-1520340356584-f9166066d143?w=500&h=750&fit=crop"
                alt="Vehicle detailing" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            </div>
          </Fade>
        </div>
      </section>
          ...
          <Fade delay={0.1}>
            <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 28, flexWrap: "wrap" }}>
              {trustedLogos.map((name, i) => (
                <div key={i} style={{
                  width: 85, height: 85, borderRadius: "50%", background: C.bg,
                  border: `1px solid ${C.border}`, display: "flex", alignItems: "center", justifyContent: "center",
                  fontSize: 10, fontWeight: 600, letterSpacing: 0.3, color: C.textLight, textAlign: "center",
                  lineHeight: 1.3, padding: 10, whiteSpace: "pre-line",
      ...
      <section id="benefits" style={{ background: C.bg, borderTop: `1px solid ${C.border}` }}>
        <div className="as-section">
          ...
          <div className="as-benefits-grid" style={{ display: "flex", gap: 40, marginTop: 48, alignItems: "stretch" }}>
                ...
                <Fade key={i} delay={i * 0.08}>
                  <div style={{ display: "flex", gap: 16, alignItems: "flex-start" }}>
                    ...
                    <div>
                      ...
                      <p style={{ fontSize: 14, lineHeight: 1.7, color: C.text }}>{b.desc}</p>
                    </div>
                  </div>
                </Fade>
              ))}
            ...
            <Fade delay={0.15} style={{ flex: "1 1 400px" }}>
              <div className="as-benefits-img" style={{
